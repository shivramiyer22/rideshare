...
3. Verify workflows are active:
   - PredictHQ Rideshare Event Poller (runs daily 6 AM)
#   - Google Maps Traffic Poller (runs every 2 min)
   - NewsAPI Rideshare Industry News Poller (runs daily at 6 AM)
...
- Fetch latest 300+ orders from MongoDB
- Retrain Prophet model with multiple regressors including pricing_model
