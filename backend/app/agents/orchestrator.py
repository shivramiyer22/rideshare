...
try:
    orchestrator_agent = create_agent(
        ...
        "- HISTORICAL data queries (e.g., 'November average price', 'monthly statistics') → Analysis Agent "
        "- Average unit price by month → Analysis Agent (has access to historical_rides database) "
        "- Price calculations for NEW rides, pricing explanations → Pricing Agent "
        "- Forecasts, predictions, future demand forecasting → Forecasting Agent "
        "- Strategic recommendations, business advice → Recommendation Agent "
        "\n\n"
        "Important: Questions about PAST/HISTORICAL data (specific months, average prices from data) "
        "should go to Analysis Agent, NOT Pricing Agent. Pricing Agent calculates prices for new rides. "
        "\n\n"
